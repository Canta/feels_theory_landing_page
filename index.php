...
<html>
  ...
  <body>
    <img class="iChannel" id="iChannel0" src="" />
    <img class="iChannel" id="iChannel1" src="" />
    <img class="iChannel" id="iChannel2" src="" />
    <img class="iChannel" id="iChannel3" src="" />
    ...
    <script type="text/glsl" id="vertex-shader">
      ...
      float trunc( float x, float n ) { return floor(x*n); }
      ...
      void main()
      {
        ...
        vec2 q = vec2( - fragCoord.x + 0.5, (fragCoord.y * 2.0) + 0.5);
